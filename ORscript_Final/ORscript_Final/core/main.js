    ...
    function build() {
      ...
      root.innerHTML = `
        <div id="rs-bar">
          ...
          <button id="rs-figma-btn" type="button" aria-label="Figma Bridge" title="Figma Bridge (Floating)"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 5.5A3.5 3.5 0 0 1 8.5 2H12v7H8.5A3.5 3.5 0 0 1 5 5.5z"/><path d="M12 2h3.5a3.5 3.5 0 1 1 0 7H12V2z"/><path d="M12 12.5a3.5 3.5 0 1 1 7 0 3.5 3.5 0 1 1-7 0z"/><path d="M5 19.5A3.5 3.5 0 0 1 8.5 16H12v3.5a3.5 3.5 0 1 1-7 0z"/><path d="M5 12.5A3.5 3.5 0 0 1 8.5 9H12v7H8.5A3.5 3.5 0 0 1 5 12.5z"/></svg></button>
        ...
        <div id="rs-figma-widget" class="rs-figma-float" hidden>
          <div class="rs-figma-float-head" id="rs-figma-drag-handle">
            <span class="rs-figma-icon">❖</span>
            <span class="rs-figma-title">Figma Live Bridge</span>
            <span class="rs-figma-badge" id="rs-figma-status-badge">OFF</span>
            <button type="button" class="rs-figma-close" id="rs-figma-close-btn" title="Close">✕</button>
          </div>
          <div class="rs-figma-float-body">
            <div class="rs-figma-note">Companion plugin running in Figma Desktop (Port 9878). Prompt to build on canvas & auto-export.</div>
            <div class="rs-figma-actions-row">
              <button type="button" class="rs-figma-btn primary" id="rs-figma-connect-btn">Connect Figma</button>
              <button type="button" class="rs-figma-btn" id="rs-figma-export-btn" title="Export selection to Studio">Export to Studio</button>
            </div>
            <div class="rs-figma-info" id="rs-figma-log">Ready. Plugins → Development → OR Figma Bridge in Figma.</div>
          </div>
        </div>
